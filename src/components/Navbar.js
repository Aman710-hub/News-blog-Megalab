        ...
        <div className="nav_icons">
          <div className="search_box">
            ...
            >
              ...
              >
                <path
                  d="M13.2917 22.9583C18.6304 22.9583 22.9583 18.6304 22.9583 13.2917C22.9583 7.95291 18.6304 3.625 13.2917 3.625C7.95291 3.625 3.625 7.95291 3.625 13.2917C3.625 18.6304 7.95291 22.9583 13.2917 22.9583Z"
                  stroke="#7E5BC2"
                  strokeWidth="2"
                  strokeLinecap="round"
                ...
                />
                <path
                  d="M25.3749 25.375L20.1187 20.1187"
                  stroke="#7E5BC2"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          >
            ...
            >
              <path
                d="M19.6934 19.81V18.4567C19.6934 17.7388 19.4082 17.0504 18.9006 16.5428C18.393 16.0352 17.7046 15.75 16.9867 15.75H11.5734C10.8555 15.75 10.1671 16.0352 9.65946 16.5428C9.15186 17.0504 8.8667 17.7388 8.8667 18.4567V19.81"
                stroke="#7E5BC2"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M14.2799 13.0433C15.7748 13.0433 16.9866 11.8315 16.9866 10.3367C16.9866 8.84182 15.7748 7.63 14.2799 7.63C12.7851 7.63 11.5732 8.84182 11.5732 10.3367C11.5732 11.8315 12.7851 13.0433 14.2799 13.0433Z"
                stroke="#7E5BC2"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <circle cx="14" cy="14" r="13" stroke="#7E5BC2" strokeWidth="2" />
            </svg>
            {activePerson && (
